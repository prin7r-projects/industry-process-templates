...
This Standard Operating Procedure defines the step-by-step process for intercompany transaction elimination. Following this SOP ensures consistency, quality, and compliance across all engagements in the accounting vertical.

## Scope

This SOP applies to all team members involved in accounting operations. Contractors and temporary staff must also follow this procedure unless an approved exception is documented.
