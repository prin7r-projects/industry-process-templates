...
This prompt pack provides AI-assisted workflows for social media seasonal content calendar in the hvac vertical. Use these prompts with ChatGPT, Claude, or any LLM that supports system/user message patterns.
...
```
You are an expert hvac operations consultant helping a business implement best practices. Your task is to assist with social media seasonal content calendar. Provide actionable, specific guidance that a practitioner can follow immediately. Use industry-standard terminology and reference relevant regulations where applicable.
```
...
# Social Media Seasonal Content Calendar: Expert Guidance
...
- Map your current social media seasonal content calendar workflow on a whiteboard before touching any system.
...
```
Generate a professional template for social media seasonal content calendar in the hvac industry. Include all standard sections, placeholder text that guides the user, and annotations explaining what goes in each section. Format the output as clean Markdown.
```
...
```
A hvac professional is experiencing issues with social media seasonal content calendar. They describe the problem as: [INSERT PROBLEM]. Provide a structured troubleshooting approach with: 1) Likely causes (ranked by probability), 2) Diagnostic steps, 3) Resolution procedures, and 4) Prevention measures.
```
...
```
Draft a professional email to a client about social media seasonal content calendar in the hvac context. The tone should be [choose: reassuring / urgent / informational]. Include: subject line, greeting, body with clear next steps, and closing. Keep it concise but thorough.
```
...
**Subject:** Update: Social Media Seasonal Content Calendar — Next Steps

Hi [Client Name],

I wanted to share a quick update on social media seasonal content calendar.
...
```
Create a 30-minute training module outline for social media seasonal content calendar targeting new hvac team members. Include: learning objectives, key concepts, hands-on exercises, assessment questions, and suggested follow-up resources.
```
...
# Training Module: Social Media Seasonal Content Calendar

**Duration:** 30 minutes  
**Audience:** New HVAC team members  
**Prerequisites:** Basic HVAC operations knowledge

## Learning Objectives
By the end of this module, participants will be able to:
1. Explain the purpose and scope of social media seasonal content calendar.
...
Participants will execute a simulated social media seasonal content calendar scenario using the sandbox environment. The exercise covers data input and validation, core processing, exception handling, and documentation.
