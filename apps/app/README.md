...
This folder is a placeholder for the upcoming SaaS app that will sit behind the Plumbline storefront and own:
...
1. Strip default email/Stripe billing — Plumbline uses NOWPayments.
